...
test_cfg = dict(
    ...
    lr_scheduler=dict(type='ExponentialLR', gamma=0.988),
...
data = dict(
    ...
    val_cond=dict(
        type=dataset_type,
        data_prefix='data/shapenet/cars_test',
        specific_observation_idcs=[0,8,16,24,32,40,48,56,65,73,81,89,97,105,113,121,129,137,145,153,161,169,177,185,194,202,210,218,226,234,242,250],
...
checkpoint_config = dict(interval=save_interval, by_epoch=False, max_keep_ckpts=4,create_symlink=False )
evaluation = [
    dict(
