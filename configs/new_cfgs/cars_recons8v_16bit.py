...
train_cfg = dict(
    ...
    n_decoder_rays=2 ** 12,             # ray batch size
    loss_coef=0.1 / (128 * 128),        # loss coefficient
...
data = dict(
    ...
    val_cond=dict(
        type=dataset_type,
        data_prefix='data/shapenet/cars_test',
        specific_observation_idcs=[0,36,71,107,143,179,214,250],
        num_test_imgs=251 - 8,              
        cache_path='data/shapenet/cars_test_cache.pkl'),
...
checkpoint_config = dict(interval=save_interval, by_epoch=False, max_keep_ckpts=3,create_symlink=False )
