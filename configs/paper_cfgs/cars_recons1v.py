...
model = dict(
    ...
    normal_loss=dict(
        type='NormalLoss',
        loss_type='consistency',  # 或 'smoothness'
        loss_weight=1.0
    ),
...
lr_config = dict(
    ...
    warmup_iters=500,
    warmup_ratio=0.001)
checkpoint_config = dict(interval=save_interval, by_epoch=False, max_keep_ckpts=2,create_symlink=False,save_last=True,save_optimizer=True)
